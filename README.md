...
### Para inicializar o projeto em sua máquina:
  ...
  - ⚠️ Todos os comandos descritos abaixo devem ser executados no terminal dentro da pasta raíz do projeto, após ser feito o clone do repositório com o comando `git@github.com:ggtenari/delivery-app.git`.
